...
{
    public class CustomGroupButton<T> : UIElement, IGroupOptionButton
    {
        public T _currentOption;
        ...
        public readonly Asset<Texture2D> _iconTexture;

        public readonly T _myOption;
        ...
        public float _whiteLerp = 0.7f;

        public float _opacity = 0.7f;
        ...
        public bool _UseOverrideColors;

        public Color _overrideUnpickedColor = Color.White;

        public Color _overridePickedColor = Color.White;

        public float _overrideOpacityPicked;

        public float _overrideOpacityUnpicked;

        public readonly string Description;

        public UIText _title;
        ...
        public CustomGroupButton(T option, string title, string description, Color textColor, Asset<Texture2D> iconTexture, float textSize = 1f, float titleAlignmentX = 0.5f, float titleWidthReduction = 10f)
        {
